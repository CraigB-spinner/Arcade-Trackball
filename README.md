...
**Proceed at own risk.**  
You maybe lucky and not require an ISP Programmer, if fuse bit JTAGEN=1 has been factory set. You will need to test confirm with LED and resistor anyway.  
