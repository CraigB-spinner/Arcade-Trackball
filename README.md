...
**My LED driver board:**  
required multiple redesigns due to 5050RGB LED strip board positive anode side switches, requiring a P-Channel MOSFET. I also had issues sourcing some components locally.  
