...
Simple explaination, a trackball is a dual digital rotary encoder with each axis acting as a quadrature input device or spinner. Instead of turning the spinner knob directly, a ball contacts either roller that twists/turns the individual axis encoder. A rotary encoder have dual A & B phases with low/high or high/low signal transistions. One phase will always follow another phase due to a physical offset with a complete cycle producing 4 pulses (A<sub>H</sub>, B<sub>H</sub>, A<sub>L</sub>, B<sub>L</sub>) or quadrature signal. Only rwo temperal dual AB states of AB or BA signals need to be deciphered from eight out of sixteen valid combinations. Two sets of four will indicate clockwise or counter-clockwise movement. A signal of AA, BB or similar will suggest invalid transitional states or bounce and be ignored.<br/><br/>
