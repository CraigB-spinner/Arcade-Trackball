...
This [trackball](Pics/Retro%20Arcade%203in%20Trackball%20and%20Harness.jpg), RA-TRACKBALL-2, uses the [red Opto boards](Pics/Red_Board_Pinout.jpg), A052-1011-00, and not the green PS/2 Opto board pair. Do not confuse with Jamma 60-in-1 style trackballs; board pair outputs PS/2 protocol (6-pin header), and not quadrature rotary encoder pulses for x/y axes (10-pin header/dual player).<br/> 
