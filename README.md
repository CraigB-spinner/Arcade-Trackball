...
wood sides have <sup>7</sup>/<sub>16</sub>" rabbet butt joints glued, and <sup>7</sup>/<sub>16</sub>" rabbet joint along inside bottom edge to allow plywood panel to recess in flush.  
The outside bottom edge has a ¼ round using a router. Physical dimensions of [Trackball](Pics/RA-Trackball-2%20dimensions.jpg) are shimmed by four wooden blocks on right side, bottom side, and two on the bottom. Block dimensions will vary with your own inside/outside box dimensions; leave space under ball to allow lighting and "Dust Bunny" particles to fall through. 
