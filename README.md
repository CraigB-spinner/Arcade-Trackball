...
<sup>Colours correspond to generic Atari/Happ Game Elf (138-in-1) 10 pin wire harness, Suzo/Happ 6 pin wire harness uses same colours but flip-flop to X & Y axes.</sup><br/>
...
--- |---- |------------ |----
0   |D1   |Y<sub>A</sub> trackball - Yellow |PD3/PinC
1   |D0   |Y<sub>B</sub> trackball - Green |PD2/PinD
